using AKD.AKDTrading.Services.Ordering.API.Application.Commands;
using AKD.AKDTrading.Services.Ordering.API.Infrastructure.Services;
using AKD.AKDTrading.Services.Ordering.Domain.AggregatesModel.BuyerAggregate;
using AKD.AKDTrading.Services.Ordering.Domain.AggregatesModel.OrderAggregate;
using Moq;
using System;
