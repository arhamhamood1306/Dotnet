...
namespace IdentityAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserDetails userDetails)
        {
            ...
            var identityUser = new ApplicationUser() { UserName = userDetails.UserName};
        ...
        [HttpPost]
        [Route("RevokeToken")]
        private IActionResult RevokeToken(string token)
        {
        ...
        private  string GenerateAccessToken(ApplicationUser identityUser)
        {
            ...
            /*
            var UserRoles = await this.userManager.GetRolesAsync(identityUser);
